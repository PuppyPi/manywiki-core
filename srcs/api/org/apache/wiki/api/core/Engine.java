...
public interface Engine {
	...
	@AccessedDynamicallyOrExternallyToJavaOrKnownToBeInImportantSerializedUse  //by JSP!
	public default String newProgressIdentifier()
	{
		return this.getManager( ProgressManager.class ).getNewProgressIdentifier();
	}
	
	@AccessedDynamicallyOrExternallyToJavaOrKnownToBeInImportantSerializedUse  //by JSP!
	public default String getNameAndVersion()
	{
		return Release.APPNAME+" v"+Release.getVersionString();
	}
	
	@AccessedDynamicallyOrExternallyToJavaOrKnownToBeInImportantSerializedUse  //by JSP!
	public default List<String> getEditors()
	{
